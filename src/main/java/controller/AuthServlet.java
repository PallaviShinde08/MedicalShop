...
public class AuthServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        out.println("<html><head><title>Online Medical Shop - Auth</title>");
        ...
        switch (pathInfo) {
            ...
            default:
                if (user != null) {
                    ...
                    out.println("<p>Explore our medicines, manage your cart and orders.</p>");
                } else {
                    out.println("<h1>Welcome to Online Medical Shop</h1>");
        ...
        try (Session dbSession = HibernateUtil.getSessionFactory().openSession()) {
            if ("/register".equals(pathInfo)) {
                ...
                if (existingUser != null) {
                    ...
                    user.setEmail(email);
                    user.setPasswordHash(password); // Reminder: hash password for production!
